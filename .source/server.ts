// @ts-nocheck
import * as __fd_glob_7 from "../content/docs/upload.mdx?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, }, {"button.mdx": __fd_glob_1, "content.mdx": __fd_glob_2, "drop-zone.mdx": __fd_glob_3, "files.mdx": __fd_glob_4, "get-started.mdx": __fd_glob_5, "index.mdx": __fd_glob_6, "upload.mdx": __fd_glob_7, });